...
public class PagoSuscripcionWS {
    ...
    public List<PagoSuscripcion> listarPagosPorSuscripcion(@WebParam(name = "idSuscripcion") int idSuscripcion) {
        return pagoBL.listarPorSuscripcion(idSuscripcion);
    }

    @WebMethod(operationName = "buscarPagoPorId")
    public PagoSuscripcion buscarPagoPorId(@WebParam(name = "id") int id) {
        return pagoBL.buscarPorId(id);
    }

    @WebMethod(operationName = "listarPagosPorUsuario")
    public List<PagoSuscripcion> listarPagosPorUsuario(@WebParam(name = "idUsuario") int idUsuario) {
        return pagoBL.listarPorUsuario(idUsuario);
    }

    @WebMethod(operationName = "listarPagosPorEstado")
    public List<PagoSuscripcion> listarPagosPorEstado(@WebParam(name = "estado") String estado) {
