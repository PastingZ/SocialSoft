...
public class UsuarioWS {
    ...
    public int insertar(@WebParam(name = "usuario") Usuario usuario) {
        return usuarioBL.insertar(usuario);
    }

    @WebMethod(operationName = "registrarUsuarioConDispositivo")
    public int registrarUsuarioConDispositivo(@WebParam(name = "usuario") Usuario usuario, @WebParam(name = "dispositivo") DispositivoUsuario dispositivo) {
        return usuarioBL.registrarUsuarioConDispositivo(usuario, dispositivo);
    }
    ...
    public Usuario buscarPorId(@WebParam(name = "id") int id) {
        return usuarioBL.buscarPorId(id);
    }

    @WebMethod(operationName = "buscarUsuarioPorDni")
    public Usuario buscarPorDni(@WebParam(name = "dni") String dni) {
        return usuarioBL.buscarPorDni(dni);
    }

    @WebMethod(operationName = "actualizarUsuario")
    public int actualizar(@WebParam(name = "usuario") Usuario usuario) {
