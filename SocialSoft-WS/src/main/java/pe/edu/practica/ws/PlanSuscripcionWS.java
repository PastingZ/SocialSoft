...
public class PlanSuscripcionWS {
    ...
    public int insertar(@WebParam(name = "plan") PlanSuscripcion plan) {
    ...
    public PlanSuscripcion buscarPorId(@WebParam(name = "id") int id) {
        return planBL.buscarPorId(id);
    }

    @WebMethod(operationName = "actualizarPlan")
    public int actualizar(@WebParam(name = "plan") PlanSuscripcion plan) {
